...
<nav class="bg-gray-800">
    ...
    <div class="flex items-center justify-between h-16">
        ...
        <div class="flex-shrink-0">
            <p class="text-white text-xl font-bold">My App</p>
        </div>
        ...
        <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
                <button @click="isOpen = !isOpen" class="p-1 border-2 border-transparent text-gray-400 rounded-full hover:text-white focus:outline-none focus:text-white focus:bg-gray-700" aria-label="Notifications">
